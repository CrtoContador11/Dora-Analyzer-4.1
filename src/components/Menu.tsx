  ...
  return (
    <nav className="bg-white shadow-md overflow-x-auto">
      <div className="container mx-auto px-4">
        <ul className="flex flex-nowrap space-x-1 py-2">
          {menuItems.map((item) => (
            <li key={item.view} className="flex-shrink-0">
              <button
                className={`flex items-center px-3 py-2 rounded-md transition-colors duration-200 whitespace-nowrap ${
